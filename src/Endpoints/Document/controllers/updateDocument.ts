...
export const updateDocument = async (req: Request<{ _id: string }, {}, DOC_INFO>, res: Response, next: NextFunction) => {
    ...
    try {
        ...
        const query = await pool.query({
            text: `UPDATE documents set title = CASE WHEN SUBSTRING($2 FROM 1 FOR 10) like LEFT(title, 10) THEN $2 ELSE LEFT(title, 10) || $2 END, description = $3 WHERE _id = $1 RETURNING *`,
